...
namespace VbNamespaceAnalyzer
{
    ...
    /// ドキュメントコメント自体が存在しない場合は VBNS0005 (MissingDocumentationCommentAnalyzer) の対象なので、
    /// ここでは扱わない。
    /// </summary>
    [DiagnosticAnalyzer(LanguageNames.VisualBasic)]
    public class EmptySummaryAnalyzer : DiagnosticAnalyzer
    {
        public const string DiagnosticId = "VBNS0006";
        ...
        private static readonly DiagnosticDescriptor Rule = new DiagnosticDescriptor(
            ...
            description: "ドキュメントコメントの <summary> 要素には、空でない説明を記述する必要があります。" +
                         "一致させるには、.editorconfig で dotnet_diagnostic.VBNS0006.severity を設定してください。");
